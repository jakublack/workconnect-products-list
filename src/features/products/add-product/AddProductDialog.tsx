  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent
        ...
        className="flex flex-col gap-0 p-0 sm:max-h-[calc(100dvh-2rem)] sm:max-w-[720px] max-sm:inset-0 max-sm:max-w-none max-sm:translate-none max-sm:rounded-none max-sm:ring-0"
      >
